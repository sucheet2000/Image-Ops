    ...
    faq: [
      {
        ...
        answer:
          'Resizing can reduce quality if dimensions are heavily reduced, so we preserve aspect ratio and apply tuned resampling.',
      },
      {
        question: 'Can I target exact marketplace dimensions?',
        answer:
          'Yes, set width and height per channel requirement while keeping fit rules for safe cropping behavior.',
      },
    ],
  },
  {
    ...
    whenToUse:
      'Use this before publishing when storefront speed or upload limits are your primary constraint.',
    keywords: ['compress image', 'reduce image size', 'optimize listing photos'],
    faq: [
      {
        question: 'Will compression make my product photos blurry?',
        answer:
          'Compression settings are tuned for listing photos to reduce bytes while preserving visual detail for storefront use.',
      },
      {
        question: 'How much can file size drop?',
        answer:
          'Results vary by source image, but JPEG and WEBP assets often shrink significantly without visible degradation.',
      },
    ],
  },
  {
    ...
    whenToUse:
      'Use this when your destination platform requires a specific format or transparency behavior.',
    keywords: ['convert image format', 'jpg png webp converter', 'marketplace format'],
    faq: [
      {
        question: 'When should I use PNG instead of JPG?',
        answer:
          'Use PNG when transparency or crisp graphic edges matter; use JPG for smaller photo file sizes.',
      },
      {
        question: 'Does conversion preserve dimensions?',
        answer:
          'Yes, format conversion keeps pixel dimensions unless resize options are explicitly provided.',
      },
    ],
  },
  {
    ...
    whenToUse:
      'Use this for hero images and ads where subject isolation improves clarity and compliance.',
    keywords: ['remove background', 'product photo cutout', 'transparent background'],
    faq: [
      {
        question: 'Why is background removal marked advanced?',
        answer:
          'Background removal is compute-heavy and receives watermarking on free plans by policy.',
      },
      {
...
export const AUDIENCE_INTENT_PAGES: AudienceIntentPage[] = [
  {
    ...
    summary:
      'Prepare white-background, compliant hero images for Amazon listings with minimal rework.',
    recommendedTools: ['background-remove', 'resize', 'compress'],
    faq: [
      {
        question: 'Can this workflow help with white background requirements?',
        answer:
          'Yes, background removal plus format and size controls are designed for marketplace compliance workflows.',
      },
      {
        question: 'Do I need all tools for every image?',
        answer:
          'No, start with background remove only when needed, then resize/compress based on target channel requirements.',
      },
    ],
  },
  {
    ...
    summary:
      'Create clean Etsy thumbnails that load quickly and keep product focus in search and category grids.',
    recommendedTools: ['resize', 'compress', 'convert'],
    faq: [
      {
        question: 'Why optimize thumbnails separately?',
        answer:
          'Thumbnail-specific optimization improves listing load speed and visual consistency across catalog pages.',
      },
      {
        question: 'Which format should I choose?',
        answer:
          'Use JPG for photographic assets and PNG when transparency is required for graphic overlays.',
      },
    ],
  },
  {
    ...
    summary:
      'Produce campaign-ready assets for Shopify ads with clean cutouts and controlled file sizes.',
    recommendedTools: ['background-remove', 'compress', 'convert'],
    faq: [
      {
        question: 'Can I reuse the same output for multiple ad networks?',
        answer:
          'Yes, convert and compress outputs per network constraints while reusing the same edited source.',
      },
      {
        question: 'How do I reduce rejection risk?',
        answer:
          'Run channel-specific dimensions and file-size checks before final upload to each ad platform.',
      },
    ],
  },
  {
    ...
    faq: [
      {
        ...
        answer:
          'Yes, consistent dimensions help reduce listing layout shifts and moderation flags.',
      },
      {
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Use one default format where possible, then carve out exceptions for transparency needs.',
      },
    ],
  },
  {
...
export const GUIDE_PAGES: GuidePage[] = [
  {
    ...
    summary:
      'A practical sequence to produce compliant Amazon hero images with minimal manual edits.',
    steps: [
    ...
    faq: [
      {
        ...
        answer:
          'Remove background first, then resize, then compress to avoid repeated quality loss.',
      },
    ],
  },
  {
    ...
    summary:
      'Generate faster, cleaner Etsy thumbnails that preserve product clarity in search views.',
    steps: [
    ...
    faq: [
      {
        ...
        answer:
          'WEBP often gives strong compression, but confirm marketplace compatibility for your storefront setup.',
      },
    ],
  },
  {
    ...
    summary:
      'Convert and optimize large image sets across channels while keeping output quality predictable.',
    steps: [
    ...
    faq: [
      {
        ...
        answer:
          'Yes, but keep the order consistent and verify output dimensions for each channel requirement.',
      },
    ],
  },
  {
    ...
    faq: [
      {
        question: 'Should hero images stay lossless?',
        answer:
          'Use lossless only when detail demands it. Most photo galleries are fine with tuned lossy compression.',
      },
    ],
  },
  {
    ...
    faq: [
      {
        question: 'How do I avoid visual drift across relists?',
        answer: 'Lock one dimension profile and one compression profile per listing class.',
      },
    ],
  },
  {
    ...
    faq: [
      {
        question: 'What fails QA most often?',
        answer: 'Dimension mismatches and oversized files are the most frequent failures.',
      },
    ],
  },
  {
    ...
    faq: [
      {
        question: 'Can I skip background removal?',
        answer: 'Yes. Use it selectively where background noise hurts product focus.',
      },
    ],
  },
  {
    ...
    faq: [
      {
        question: 'Should I keep one format for all pins?',
        answer: 'A single default format simplifies workflows; add exceptions only when needed.',
      },
    ],
  },
  {
    ...
    faq: [
      {
        question: 'Why process hero images first?',
        answer: 'Hero assets get the most impressions, so they should be optimized first.',
      },
    ],
  },
  {
    ...
    faq: [
      {
        question: 'Can I preserve transparency during migration?',
        answer: 'Yes, keep PNG/WEBP for assets requiring transparent backgrounds.',
      },
    ],
  },
  {
    ...
    faq: [
      {
        question: 'What quality level works for mobile thumbnails?',
        answer: 'Start around 75-85 and tune by product category and visual texture.',
      },
    ],
  },
];
...
export const COMPARE_PAGES: ComparePage[] = [
  {
    ...
    summary:
      'Choose the right format for photos, transparency, and marketplace delivery constraints.',
  ...
  },
  {
    ...
    summary:
      'Determine whether dimensions or quality settings should be your first optimization lever.',
    winnerWhen: 'Resize first when the source dimensions are much larger than target placement.',
    winnerBut:
      'Compress first when dimensions are already correct and payload size is the only issue.',
    decisionChecklist: [
  ...
  },
  {
    ...
    winnerBut:
      'Multi-pass wins when you need fine-grained control over output quality and compliance.',
    decisionChecklist: [
...
export function findAudienceIntent(audience: string, intent: string): AudienceIntentPage | null {
  return (
    AUDIENCE_INTENT_PAGES.find((item) => item.audience === audience && item.intent === intent) ||
    null
  );
}
