...
const envSchema = z
  .object({
    ...
    API_WRITE_RATE_LIMIT_WINDOW_MS: z.coerce
      .number()
      .int()
      .positive()
      .default(60 * 1000),
    ...
    TEMP_OBJECT_TTL_SECONDS: z.coerce
      .number()
      .int()
      .positive()
      .default(30 * 60),
    CLEANUP_IDEMPOTENCY_TTL_SECONDS: z.coerce
      .number()
      .int()
      .positive()
      .default(24 * 60 * 60),
    BILLING_CHECKOUT_TTL_SECONDS: z.coerce
      .number()
      .int()
      .positive()
      .default(15 * 60),
    ...
    BILLING_PROVIDER_SECRET: z
      .string()
      .min(1, 'BILLING_PROVIDER_SECRET is required')
      .default('dev-provider-secret'),
    BILLING_WEBHOOK_SECRET: z
      .string()
      .min(1, 'BILLING_WEBHOOK_SECRET is required')
